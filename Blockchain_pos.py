...
class Blockchain(object):
    ...
    def generate_new_block(self, current_transaction=[randint(1, 63)], oldBlock='', address=''):
        if self.myCurrBlock:
        ...
        newBlock = {
            ...
            "current_transaction": current_transaction, #instead of transactions
            "PrevHash": prevHash,
            "Validator": address
        }
    ...
    def generate_genesis_block(self, genesisblock):
        ...
        genesisblock['current_transaction'] = [0] if not genesisblock['current_transaction'] else genesisblock['current_transaction']
